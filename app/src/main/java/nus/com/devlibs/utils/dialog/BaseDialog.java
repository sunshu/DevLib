...
import nus.com.devlibs.utils.animator.BaseAnimatorSet;
import nus.com.devlibs.utils.hardware.StatusBarUtils;

/**
 * Created by nus on 16-8-2.
 */
public abstract class BaseDialog<T extends BaseDialog<T>>  extends Dialog {
    ...
    protected float mHeightScale=1;
    /** mShowAnim(对话框显示动画) */
...
//            height = ViewGroup.LayoutParams.MATCH_PARENT;
        ...
        if (mShowAnim != null) {
            mShowAnim.listener(new BaseAnimatorSet.AnimatorListener() {
                ...
                public void onAnimationStart(Animator animator) {
                    Intent i = new Intent("com.minzou.show.anim");
    ...
    public void onDetachedFromWindow() {
        ...
        Log.i(mTag, "onDetachedFromWindow");
    }
